...
luaopen_dwm_client(lua_State* L) {
    const luaL_Reg lib[] = {
        {"clients", f_clients},   {"client", f_client},     {"show", f_show},   {"hide", f_hide},
        {"border", f_border},     {"close", f_close},       {"focus", f_focus}, {"maximize", f_maximize},
        {"minimize", f_minimize}, {"position", f_position}, {NULL, NULL}};
