...
static Layout layouts[] = {
    ...
    {L"[M]", monocle}, {L"TTT", bstack}, {L"###", gaplessgrid}, {L"+++", grid}, {L"(@)", spiral}, {L"[\\]", dwindle},
};

/* key definitions */
#    define MODKEY (MOD_ALT)
#    define TAGKEYS(KEY, TAG)                                                                                          \
        {MODKEY, KEY, view, {.ui = 1 << TAG}}, {MODKEY | MOD_CONTROL, KEY, toggleview, {.ui = 1 << TAG}},              \
...
static Key keys[] = {
    ...
    TAGKEYS('1', 0) TAGKEYS('2', 1) TAGKEYS('3', 2) TAGKEYS('4', 3) TAGKEYS('5', 4) TAGKEYS('6', 5) TAGKEYS('7', 6)
        TAGKEYS('8', 7) TAGKEYS('9', 8){MODKEY | MOD_CONTROL, 'Q', quit, {0}},
};
...
static Button buttons[] = {
    /* click                button event type     modifier keys    function
       argument */
    {ClkLtSymbol, WM_LBUTTONDOWN, 0, setlayout, {0}}, {ClkLtSymbol, WM_RBUTTONDOWN, 0, setlayout, {.v = &layouts[2]}},
    {ClkWinTitle, WM_MBUTTONDOWN, 0, zoom, {0}},      {ClkStatusText, WM_MBUTTONDOWN, 0, spawn, {.v = termcmd}},
#    if 0
    { ClkClientWin,         WM_MBUTTONDOWN,       MODKEY,          togglefloating, {0} },
#    endif
    {ClkTagBar, WM_LBUTTONDOWN, VK_MENU, tag, {0}},   {ClkTagBar, WM_RBUTTONDOWN, VK_MENU, toggletag, {0}},
    {ClkTagBar, WM_LBUTTONDOWN, 0, view, {0}},        {ClkTagBar, WM_RBUTTONDOWN, 0, toggleview, {0}},
};
